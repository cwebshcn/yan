...
<?php if($action==""){?>
	...
	while ($rs=mysqli_fetch_assoc($result)){
		...
		echo "<td><a href='?act=addnew&menuid=$menuid'><span class='glyphicon glyphicon-plus'></span></a>
		&nbsp;&nbsp;&nbsp;<a href='?act=edita&menuid=$menuid&pid=".$rs["item_id"]."'>
		<span class='glyphicon glyphicon-pencil'></span></a>&nbsp;&nbsp;&nbsp;
		<a href='javascript:void(0)' onClick='confirmLink(".$rs["item_id"].")'>
		<span class='glyphicon glyphicon-remove'></span></a></td>";  //操作
		echo "</tr>";
...
$insert_sql="insert into  (manage_id,title,logo,content,wx_img,code_img,target_num,reg_time)values('$manage_id','$title','$logo','$content','$wx_img','$code_img','$target_num','$reg_time')";
//echo $insert_sql;
