...
<tr>
<td colspan=6 class=td height=25>会员管理 &nbsp;</td>
</tr>
<tr>
<td align=center width=3%>选</td>
<td width="11%" align=center>联系人/呢称</td>
...
if (@$_REQUEST['fs']=="search") {$str="username like '%".$keyword."%'";
$sql="select * from massage where ".$str."  order by id";}
else {$sql="select * from  massage  order by id";}
//没页显示记录数
$PageSize = 20;
...
<td align="center"><a href="message.php?act=view&pid=<?php echo $row["id"];?>">查看</a></td>
</tr>
<?php
$i++;
}
...
if(!$pid or $pid==0)
exit();
$sql="select * from  massage where id=$pid";
